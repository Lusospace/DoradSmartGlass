...
namespace UnityEngine
{
	...
	public sealed class FoveInterface2 : FoveInterfaceBase
	{
        ...
        public override bool ConnectCompositor()
        {
            ...
            InputTracking.disablePositionalTracking = position;

            _compositorLayer = new SFVR_CompositorLayer()
            {
                layerId = 0,
                idealResolutionPerEye = new SFVR_Vec2i() {
                    x = XRSettings.eyeTextureWidth,
                    y = XRSettings.eyeTextureHeight
                }
            };
